...
/* MEMORY MAP USEFUL MASKS */
#define MASK_REG_CONFIG_2BYTES_CRC						0x0C
#define MASK_REG_CONFIG_RESET_STATUS					0x70
#define MASK_REG_CONFIG_POWER							0x02
#define MASK_REG_CONFIG_PRIM_RX							0x01
#define MASK_REG_CONFIG_POWER_UP_RX						0x03
#define MASK_REG_CONFIG_RX_DX							0x40
#define MASK_REG_CONFIG_TX_DS							0x20
#define MASK_REG_CONFIG_TX_DS_MAX_RT					0x30
#define MASK_REG_EN_AA_AUTO_ACK_ALL_PIPES				0x3F
#define MASK_REG_EN_AA_AUTO_ACK_NO_PIPES				0x00
#define MASK_REG_EN_RXADDR_PIPES_1_2_ENABLE				0x03
#define MASK_REG_SETUP_AW_5BYTES_ADDR_FIELD				0x03
#define MASK_REG_SETUP_RETR_SET_15RETR_1250DELAY		0x4F
#define MASK_REG_RF_CH_SET_CHANNEL_52					0x34
#define MASK_REG_RF_SETUP_POWER_0DBM_2MBPS				0x0F
#define MASK_REG_STATUS_CLEAR							0x0E
#define MASK_REG_OBSERVE_TX_CLEAR						0x00
#define MASK_REG_CD_CLEAR								0x00
#define MASK_REG_RX_PW_P_PIPE_NOT_USED					0x00
#define MASK_REG_FIFO_STATUS_RX_FIFO_EMPTY_FLAG			0x01
#define MASK_REG_DYNPD_DISABLE_DYNAMIC_PAYLOAD			0x00
#define MASK_REG_FEATURE_DISABLE_DYNAMIC_PAYLOAD		0x00
